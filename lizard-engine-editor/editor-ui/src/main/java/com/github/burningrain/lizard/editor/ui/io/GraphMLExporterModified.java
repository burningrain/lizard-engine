...
public class GraphMLExporterModified<V, E> extends BaseExporter<V, E> implements GraphExporter<V, E> {
     ...
     */
    public GraphMLExporterModified() {
     ...
     */
    public GraphMLExporterModified(Function<V, String> vertexIdProvider) {
    ...
    private void writeData(TransformerHandler handler, String key, String value)
        ...
        handler.startCDATA(); // todo modified
        handler.characters(value.toCharArray(), 0, value.length());
        handler.endCDATA(); // todo modified
    ...
    private void writeNodes(TransformerHandler handler, Graph<V, E> g)
        ...
        for (V v : g.vertexSet()) {
            ...
            for (Map.Entry<String, AttributeDetails> e : registeredAttributes.entrySet()) {
    ...
    private void writeEdges(TransformerHandler handler, Graph<V, E> g)
        ...
        for (E e : g.edgeSet()) {
            ...
            // check all registered
            for (Map.Entry<String, AttributeDetails> entry : registeredAttributes.entrySet()) {
